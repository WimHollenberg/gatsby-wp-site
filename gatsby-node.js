...
exports.createPages = async ({ graphql, actions, reporter }) => {
  ...
  allWpCategory.edges.forEach(category => {
     ...
     //total number of pages for each category, rounded off to whole numbers
     const numPages = Math.ceil(numberOfPosts / postsPerPage)

     //Some categories may be empty, in which case we do not create pages
     //For 'uncategorized' we also do not create pages
